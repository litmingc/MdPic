...
class PicBedShower(QWidget):
    ...
    def __init__(self, picbedtip, parent: any = None) -> None:
        ...
        # 布局
        self.initLay(picbedtip)


    def initLay(self, picbedtip):
        # 设置滑动显示
        ...
        infohbox.addWidget(QLabel(picbedtip))  # TODO:展示图床信息
